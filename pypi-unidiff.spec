...
Source0  : https://files.pythonhosted.org/packages/bd/5c/8353e9fc547e5339d01505536eb031b17979f1ee5b8dfd27ab054282dbff/unidiff-0.7.1.tar.gz
...
%prep
%setup -q -n unidiff-0.7.1
cd %{_builddir}/unidiff-0.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643390105
...
cp %{_builddir}/unidiff-0.7.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-unidiff/ce04486e71c1dae563844223832a26bfee186ff3
