...
Source0  : https://files.pythonhosted.org/packages/79/21/1f56b1d58bf133bad24b737b96bfd5b567e9edd7e3ecbab4bf1fde6385f8/unidiff-0.7.2.tar.gz
...
%prep
%setup -q -n unidiff-0.7.2
cd %{_builddir}/unidiff-0.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643409809
...
cp %{_builddir}/unidiff-0.7.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-unidiff/ce04486e71c1dae563844223832a26bfee186ff3
